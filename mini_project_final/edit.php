	...
	<input type="text" name="uid" value="<?php echo $uid ?>" hidden  ><br>
		...
		<table border="2" cellpadding="1" cellspacing="0">
			...
			<tr>
				...
				<td><input type="text" id="mobile" name="mobile" value="<?php echo $result['mobile'] ?>"></td>
			</tr>
		
			
			<tr>
				<td>enter Date of Birth:</td>
				<td><input type="date" id="dob" name="DOB" value="<?php echo $result['DOB'] ?>"></td>
			</tr>
			...
			<tr>
				<td> enter Image:</td>
				<td><input type="file" name="uploadimage" value="<?php echo $result['Image'] ?>"></tr>
