...
//echo $name , $address, $email, $mobile,$password,$DOB,$gender,$course,$language;
 ...
 $query="UPDATE `registration` SET `name`='$name', `address`='$address', `email`='$email', `mobile`='$mobile', `DOB`='$DOB', `gender`='$gender', `Course`='$course', `Language`='$language', `Image`='$folder' where userid='$uid'";
